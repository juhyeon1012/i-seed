...
if __name__=="__main__" :
    ...
    t1=turtle.Turtle('turtle'); t1.color('red');t1.penup() ; t1.turtlesize(1)
    t2=turtle.Turtle('turtle'); t2.color('green');t2.penup() ; t2.turtlesize(1)
    t3=turtle.Turtle('turtle'); t3.color('blue');t3.penup() ; t3.turtlesize(1)
